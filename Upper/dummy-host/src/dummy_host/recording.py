    ...
    def _create_schema(connection: sqlite3.Connection) -> None:
        ...
        connection.execute(
            ...
            CREATE TABLE IF NOT EXISTS can_diagnostics (
                ...
                session_epoch INTEGER NOT NULL,
                motor_marker_mask INTEGER NOT NULL,
                window_flags INTEGER NOT NULL,
                window_reset_count INTEGER NOT NULL,
                window_start_us INTEGER NOT NULL,
                window_duration_us INTEGER NOT NULL,
                target_tx_complete_json TEXT NOT NULL,
                position_request_json TEXT NOT NULL,
                position_response_json TEXT NOT NULL,
                position_timeout_json TEXT NOT NULL,
                temperature_request_json TEXT NOT NULL,
                temperature_response_json TEXT NOT NULL,
                temperature_timeout_json TEXT NOT NULL,
                motor_tx_drop_json TEXT NOT NULL,
                motor_rx_error_json TEXT NOT NULL,
                motor_busoff_json TEXT NOT NULL,
                main_can_busoff_json TEXT NOT NULL,
                main_can_rx_overflow_json TEXT NOT NULL,
                main_can_rx_high_water_json TEXT NOT NULL,
                ...
                unexpected_response_count INTEGER NOT NULL,
                maintenance_response_count INTEGER NOT NULL,
                query_target_overlap_count INTEGER NOT NULL,
                target_retry_count INTEGER NOT NULL,
                target_retry_exhausted_count INTEGER NOT NULL,
                target_deadline_failure_count INTEGER NOT NULL,
                main_can_tx_abort_json TEXT NOT NULL,
                main_can_tx_error_json TEXT NOT NULL,
                main_can_tx_recovery_json TEXT NOT NULL,
                main_can_completion_overflow_json TEXT NOT NULL,
                safety_preemption_count INTEGER NOT NULL,
                max_safety_wait_us INTEGER NOT NULL,
                max_fanout_us INTEGER NOT NULL,
                max_rx_dispatch_latency_us INTEGER NOT NULL,
                main_can_rx_frame_json TEXT NOT NULL,
                main_can_tx_busy_json TEXT NOT NULL,
                transition_failure_count INTEGER NOT NULL
            )
            """
        )
    ...
    def _write_can_diagnostics(
        ...
        connection.execute(
            ...
            INSERT INTO can_diagnostics (
                host_time_ns, format_version, payload_size, session_epoch,
                motor_marker_mask, window_flags, window_reset_count,
                window_start_us, window_duration_us, target_tx_complete_json,
                position_request_json, position_response_json,
                position_timeout_json, temperature_request_json,
                temperature_response_json, temperature_timeout_json,
                motor_tx_drop_json, motor_rx_error_json, motor_busoff_json,
                main_can_busoff_json, main_can_rx_overflow_json,
                main_can_rx_high_water_json, position_timeout_count,
                temperature_timeout_count, tx_abort_count, tx_error_count,
                tx_recovery_count, unexpected_response_count,
                ...
                main_can_completion_overflow_json, safety_preemption_count,
                max_safety_wait_us, max_fanout_us,
                max_rx_dispatch_latency_us, main_can_rx_frame_json,
                main_can_tx_busy_json, transition_failure_count
            ) VALUES (
                :host_time_ns, :format_version, :payload_size, :session_epoch,
                :motor_marker_mask, :window_flags, :window_reset_count,
                :window_start_us, :window_duration_us, :target_tx_complete_json,
            ...
            """,
            {
                ...
                "motor_marker_mask": value.motor_marker_mask,
                "window_flags": value.window_flags,
                "window_reset_count": value.window_reset_count,
                "window_start_us": value.window_start_us,
                "window_duration_us": value.window_duration_us,
                "target_tx_complete_json": json.dumps(value.target_tx_complete, separators=(",", ":")),
                "position_request_json": json.dumps(value.position_request, separators=(",", ":")),
                "position_response_json": json.dumps(value.position_response, separators=(",", ":")),
                "position_timeout_json": json.dumps(value.position_timeout, separators=(",", ":")),
                "temperature_request_json": json.dumps(value.temperature_request, separators=(",", ":")),
                "temperature_response_json": json.dumps(value.temperature_response, separators=(",", ":")),
                "temperature_timeout_json": json.dumps(value.temperature_timeout, separators=(",", ":")),
                "motor_tx_drop_json": json.dumps(value.motor_tx_drop, separators=(",", ":")),
                "motor_rx_error_json": json.dumps(value.motor_rx_error, separators=(",", ":")),
                "motor_busoff_json": json.dumps(value.motor_busoff, separators=(",", ":")),
                "main_can_busoff_json": json.dumps(value.main_can_busoff, separators=(",", ":")),
                "main_can_rx_overflow_json": json.dumps(value.main_can_rx_overflow, separators=(",", ":")),
                "main_can_rx_high_water_json": json.dumps(value.main_can_rx_high_water, separators=(",", ":")),
                "position_timeout_count": value.position_timeout_count,
                "temperature_timeout_count": value.temperature_timeout_count,
                "tx_abort_count": value.tx_abort_count,
                "tx_error_count": value.tx_error_count,
                "tx_recovery_count": value.tx_recovery_count,
                "unexpected_response_count": value.unexpected_response_count,
                "maintenance_response_count": value.maintenance_response_count,
                "query_target_overlap_count": value.query_target_overlap_count,
                "target_retry_count": value.target_retry_count,
                "target_retry_exhausted_count": value.target_retry_exhausted_count,
                "target_deadline_failure_count": value.target_deadline_failure_count,
                "main_can_tx_abort_json": json.dumps(value.main_can_tx_abort, separators=(",", ":")),
                "main_can_tx_error_json": json.dumps(value.main_can_tx_error, separators=(",", ":")),
                "main_can_tx_recovery_json": json.dumps(value.main_can_tx_recovery, separators=(",", ":")),
                "main_can_completion_overflow_json": json.dumps(value.main_can_completion_overflow, separators=(",", ":")),
                "safety_preemption_count": value.safety_preemption_count,
                "max_safety_wait_us": value.max_safety_wait_us,
                "max_fanout_us": value.max_fanout_us,
                "max_rx_dispatch_latency_us": value.max_rx_dispatch_latency_us,
                "main_can_rx_frame_json": json.dumps(value.main_can_rx_frame, separators=(",", ":")),
                "main_can_tx_busy_json": json.dumps(value.main_can_tx_busy, separators=(",", ":")),
                "transition_failure_count": value.transition_failure_count,
            },
        )
