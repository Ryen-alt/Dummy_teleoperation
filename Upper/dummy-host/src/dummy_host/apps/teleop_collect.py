    ...
    if args.mode == "cartesian":
        ...
        try:
            ...
            kinematics = DummyUrdfKinematics(
                ...
                sigma_warn=profile.cartesian.sigma_warn,
                sigma_hard=profile.cartesian.sigma_hard,
                damping_min=profile.cartesian.damping_min,
                damping_max=profile.cartesian.damping_max,
                task_trust_region=profile.cartesian.task_trust_region,
                soft_limit_zone_rad=profile.cartesian.soft_limit_zone_rad,
